...
useEffect(() => {
  ...
  const handleDeleteStudent = (id) => {
    let supId;
    if (typeof id !== "string") {
      supId = encryptGlobal(JSON.stringify(id));
    } else {
    ...
    columns: [
      ...
      },
      {
        ...
        cell: (row) => [
          row.type === 0 ? (
            <span
              className="badge rounded-pill bg-outline-success"
              style={{ fontSize: "13px" }}
            >
              Pilot
            </span>
            ...
            <span
              className="badge rounded-pill bg-outline-secondary"
              style={{ fontSize: "13px" }}
            >
              Crew
            </span>
...

      {
        ...
        cell: (record) => [
          <>
            ...
            <div key={record.id} onClick={() => handleSelect1(record)}>
