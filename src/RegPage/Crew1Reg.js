      ...
      await axios(config)
        .then((mentorRegRes) => {
          if (mentorRegRes?.data?.status == 201) {
            navigate("/crew2Reg");
            openNotificationWithIcon("success", "Crew-1 Registration successfully");
          }
        })
        .catch((err) => {
        ...
        <div className="row">
          <div className="col-md-4">
            ...
            <div className="row m-2 mb-3">
              ...
              <div className="col-md-10">
                <span className='d-block current_color'>Crew-1 Information</span>
            ...
            <form action="signin" onSubmit={formik.handleSubmit}>
              <div className="login-userset">
                <div className="login-userheading">
                  <h4>Provide your Crew Member - 1 Details!</h4>
                </div>
